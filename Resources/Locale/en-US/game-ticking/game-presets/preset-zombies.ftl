...
zombie-patientzero-role-greeting = You are an [color={$subColor}]initial infected[/color]. Get supplies and prepare for your eventual transformation. Your goal is to overtake the station while infecting as many people as possible.
