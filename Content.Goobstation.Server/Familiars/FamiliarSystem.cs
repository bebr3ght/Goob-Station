...
public sealed class FamiliarSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<FamiliarComponent, AfterMindRolesBriefingEvent>(OnFamiliarInit);
        ...
        SubscribeLocalEvent<FamiliarBriefingEvent>(OnGetBrief);

        SubscribeLocalEvent<GhostRoleMobSpawnerComponent, ComponentShutdown>(OnComponentShutdown);
    }

    private void OnFamiliarInit(EntityUid uid, FamiliarComponent component, AfterMindRolesBriefingEvent args)
    {
    ...
    private void OnGetBrief(ref FamiliarBriefingEvent args)
    {
        var briefing = GetBriefingText(args.MindOwner);
