...
nukeops-welcome =
    You are a [color={$subColor}]nuclear operative[/color]. Your goal is to blow up [color={$subColor}]{$station}[/color], and ensure that it is nothing but a pile of rubble.
    Your bosses, [color={$subColor}]the Syndicate[/color], have provided you with the tools you'll need for the task. { $hasCommander ->
    [true] Your commander is [color={$subColor}]{$commander}[/color]. Operation [color={$subColor}]{$name}[/color] is a go! Death to Nanotrasen!
    *[other] Operation [color={$subColor}]{$name}[/color] is a go! Death to Nanotrasen!
}

nukeops-briefing = Your objectives are simple. Deliver the payload and get out before the payload detonates. { $hasCommander ->
    [true] Your commander is [color={$subColor}]{$commander}[/color]. Begin mission.
    *[other] Begin mission.
}
