...
abductor-role-greeting = You are a professional [color={$subColor}]combat scientist[/color] of a high-tech race.
    ...
    It is [color={$subColor}]not[/color] in your interest to destroy the station, kill, or assist the crew.
    Use + or +a in chat to talk in the Glorpmind.

abductor-briefing =
    { $hasTeammates ->
        [true] Your teammates are:
            {$teammates}
        *[other] You have no teammates.
    }
